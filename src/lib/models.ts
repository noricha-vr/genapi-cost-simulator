...
const initialModelData: ModelData[] = [
    ...
    { name: 'gpt-3.5-turbo', inputCost: 0.5, outputCost: 1.5, active: true, color: '#228B22' },
    { name: 'gpt-3.5-turbo(fine-tuning)', inputCost: 3.0, outputCost: 6.0, active: false, color: '#32CD32' },
    // Anthropic
